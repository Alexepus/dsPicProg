...
extern BYTE TableDT;
extern _Bool TableVLoaded,TdTLoaded;
...
void HardwareInit(void)
{
    ...
    RPINR18bits.U1CTSR = 7;
    RPINR18bits.U1RXR = 8;
    RPOR2bits.RP5R = 0b00100;
    RPOR3bits.RP6R = 0b00011;


    RPINR19bits.U2CTSR = 24;
    RPINR19bits.U2RXR = 22;
    RPOR12bits.RP25R = 0b00100;
    RPOR11bits.RP23R = 0b00011;


    RPOR5bits.RP11R = 0b00111;
    RPOR6bits.RP12R = 0b01000;



TRISA=0xFFFF;
TRISB=0b1100000110011111;

TRISC=0b0000000101000111;



ODCB=0b0000011000000000;
ODCC=0b0000000000111000;
...
# 155 "HardwareInit.c"
   ({ union { T1CONBITS o; unsigned int i; } lcur, lmask={}, lval={}; lmask.o.TCS = -1; ((0xAAAA) == 0xAAAA) ?({ _TN_BFA_COMMAND_ERROR_0xAAAA v = 0 +0; if (lmask.i & (lmask.i-1)){ lval.o.TCS = v; lcur.o = T1CONbits; __asm__ __volatile__ ("xor %0":"=U"(T1CON):"a"(lmask.i & (lval.i^lcur.i))); } else { if (v & 1) { T1CONbits.TCS = 1; } else { T1CONbits.TCS = 0; } } }), 0 :(((0xAAAA) == 0x3333) ?({ _TN_BFA_COMMAND_ERROR_0xAAAA v = 0 +0; lval.o.TCS = v; __asm__ __volatile__(" xor %0" :"=U"(T1CON):"a"(lmask.i & lval.i)); }), 0 :((((0xAAAA) == 0x1111) ?({ _TN_BFA_COMMAND_ERROR_0xAAAA v = 0 +0; if (lmask.i & (lmask.i-1)){ lval.o.TCS = v; __asm__ __volatile__ ("ior %0":"=U"(T1CON):"a"(lmask.i & lval.i)); } else { if (v & 1) T1CONbits.TCS = 1; } }), 0 :(((((0xAAAA) == 0x2222) ?({ _TN_BFA_COMMAND_ERROR_0xAAAA v = 0 +0; if (lmask.i & (lmask.i-1)){ lval.o.TCS = v; __asm__ __volatile__ ("and %0":"=U"(T1CON):"a"(~(lmask.i & lval.i))); } else { if (v & 1) T1CONbits.TCS = 0; } }), 0 :({ T1CONbits.TCS; }))))))); });
   ({ union { T1CONBITS o; unsigned int i; } lcur, lmask={}, lval={}; lmask.o.TGATE = -1; ((0xAAAA) == 0xAAAA) ?({ _TN_BFA_COMMAND_ERROR_0xAAAA v = 0 +0; if (lmask.i & (lmask.i-1)){ lval.o.TGATE = v; lcur.o = T1CONbits; __asm__ __volatile__ ("xor %0":"=U"(T1CON):"a"(lmask.i & (lval.i^lcur.i))); } else { if (v & 1) { T1CONbits.TGATE = 1; } else { T1CONbits.TGATE = 0; } } }), 0 :(((0xAAAA) == 0x3333) ?({ _TN_BFA_COMMAND_ERROR_0xAAAA v = 0 +0; lval.o.TGATE = v; __asm__ __volatile__(" xor %0" :"=U"(T1CON):"a"(lmask.i & lval.i)); }), 0 :((((0xAAAA) == 0x1111) ?({ _TN_BFA_COMMAND_ERROR_0xAAAA v = 0 +0; if (lmask.i & (lmask.i-1)){ lval.o.TGATE = v; __asm__ __volatile__ ("ior %0":"=U"(T1CON):"a"(lmask.i & lval.i)); } else { if (v & 1) T1CONbits.TGATE = 1; } }), 0 :(((((0xAAAA) == 0x2222) ?({ _TN_BFA_COMMAND_ERROR_0xAAAA v = 0 +0; if (lmask.i & (lmask.i-1)){ lval.o.TGATE = v; __asm__ __volatile__ ("and %0":"=U"(T1CON):"a"(~(lmask.i & lval.i))); } else { if (v & 1) T1CONbits.TGATE = 0; } }), 0 :({ T1CONbits.TGATE; }))))))); });
   ({ union { T1CONBITS o; unsigned int i; } lcur, lmask={}, lval={}; lmask.o.TSIDL = -1; ((0xAAAA) == 0xAAAA) ?({ _TN_BFA_COMMAND_ERROR_0xAAAA v = 1 +0; if (lmask.i & (lmask.i-1)){ lval.o.TSIDL = v; lcur.o = T1CONbits; __asm__ __volatile__ ("xor %0":"=U"(T1CON):"a"(lmask.i & (lval.i^lcur.i))); } else { if (v & 1) { T1CONbits.TSIDL = 1; } else { T1CONbits.TSIDL = 0; } } }), 0 :(((0xAAAA) == 0x3333) ?({ _TN_BFA_COMMAND_ERROR_0xAAAA v = 1 +0; lval.o.TSIDL = v; __asm__ __volatile__(" xor %0" :"=U"(T1CON):"a"(lmask.i & lval.i)); }), 0 :((((0xAAAA) == 0x1111) ?({ _TN_BFA_COMMAND_ERROR_0xAAAA v = 1 +0; if (lmask.i & (lmask.i-1)){ lval.o.TSIDL = v; __asm__ __volatile__ ("ior %0":"=U"(T1CON):"a"(lmask.i & lval.i)); } else { if (v & 1) T1CONbits.TSIDL = 1; } }), 0 :(((((0xAAAA) == 0x2222) ?({ _TN_BFA_COMMAND_ERROR_0xAAAA v = 1 +0; if (lmask.i & (lmask.i-1)){ lval.o.TSIDL = v; __asm__ __volatile__ ("and %0":"=U"(T1CON):"a"(~(lmask.i & lval.i))); } else { if (v & 1) T1CONbits.TSIDL = 0; } }), 0 :({ T1CONbits.TSIDL; }))))))); });


   ({ union { T1CONBITS o; unsigned int i; } lcur, lmask={}, lval={}; lmask.o.TCKPS = -1; ((0xAAAA) == 0xAAAA) ?({ _TN_BFA_COMMAND_ERROR_0xAAAA v = 2 +0; if (lmask.i & (lmask.i-1)){ lval.o.TCKPS = v; lcur.o = T1CONbits; __asm__ __volatile__ ("xor %0":"=U"(T1CON):"a"(lmask.i & (lval.i^lcur.i))); } else { if (v & 1) { T1CONbits.TCKPS = 1; } else { T1CONbits.TCKPS = 0; } } }), 0 :(((0xAAAA) == 0x3333) ?({ _TN_BFA_COMMAND_ERROR_0xAAAA v = 2 +0; lval.o.TCKPS = v; __asm__ __volatile__(" xor %0" :"=U"(T1CON):"a"(lmask.i & lval.i)); }), 0 :((((0xAAAA) == 0x1111) ?({ _TN_BFA_COMMAND_ERROR_0xAAAA v = 2 +0; if (lmask.i & (lmask.i-1)){ lval.o.TCKPS = v; __asm__ __volatile__ ("ior %0":"=U"(T1CON):"a"(lmask.i & lval.i)); } else { if (v & 1) T1CONbits.TCKPS = 1; } }), 0 :(((((0xAAAA) == 0x2222) ?({ _TN_BFA_COMMAND_ERROR_0xAAAA v = 2 +0; if (lmask.i & (lmask.i-1)){ lval.o.TCKPS = v; __asm__ __volatile__ ("and %0":"=U"(T1CON):"a"(~(lmask.i & lval.i))); } else { if (v & 1) T1CONbits.TCKPS = 0; } }), 0 :({ T1CONbits.TCKPS; }))))))); });

   PR1 = (((40000000UL / 2) / 64 / 1000) - 1);


   ({ union { IPC0BITS o; unsigned int i; } lcur, lmask={}, lval={}; lmask.o.T1IP = -1; ((0xAAAA) == 0xAAAA) ?({ _TN_BFA_COMMAND_ERROR_0xAAAA v = 2 +0; if (lmask.i & (lmask.i-1)){ lval.o.T1IP = v; lcur.o = IPC0bits; __asm__ __volatile__ ("xor %0":"=U"(IPC0):"a"(lmask.i & (lval.i^lcur.i))); } else { if (v & 1) { IPC0bits.T1IP = 1; } else { IPC0bits.T1IP = 0; } } }), 0 :(((0xAAAA) == 0x3333) ?({ _TN_BFA_COMMAND_ERROR_0xAAAA v = 2 +0; lval.o.T1IP = v; __asm__ __volatile__(" xor %0" :"=U"(IPC0):"a"(lmask.i & lval.i)); }), 0 :((((0xAAAA) == 0x1111) ?({ _TN_BFA_COMMAND_ERROR_0xAAAA v = 2 +0; if (lmask.i & (lmask.i-1)){ lval.o.T1IP = v; __asm__ __volatile__ ("ior %0":"=U"(IPC0):"a"(lmask.i & lval.i)); } else { if (v & 1) IPC0bits.T1IP = 1; } }), 0 :(((((0xAAAA) == 0x2222) ?({ _TN_BFA_COMMAND_ERROR_0xAAAA v = 2 +0; if (lmask.i & (lmask.i-1)){ lval.o.T1IP = v; __asm__ __volatile__ ("and %0":"=U"(IPC0):"a"(~(lmask.i & lval.i))); } else { if (v & 1) IPC0bits.T1IP = 0; } }), 0 :({ IPC0bits.T1IP; }))))))); });
   ({ union { IFS0BITS o; unsigned int i; } lcur, lmask={}, lval={}; lmask.o.T1IF = -1; ((0xAAAA) == 0xAAAA) ?({ _TN_BFA_COMMAND_ERROR_0xAAAA v = 0 +0; if (lmask.i & (lmask.i-1)){ lval.o.T1IF = v; lcur.o = IFS0bits; __asm__ __volatile__ ("xor %0":"=U"(IFS0):"a"(lmask.i & (lval.i^lcur.i))); } else { if (v & 1) { IFS0bits.T1IF = 1; } else { IFS0bits.T1IF = 0; } } }), 0 :(((0xAAAA) == 0x3333) ?({ _TN_BFA_COMMAND_ERROR_0xAAAA v = 0 +0; lval.o.T1IF = v; __asm__ __volatile__(" xor %0" :"=U"(IFS0):"a"(lmask.i & lval.i)); }), 0 :((((0xAAAA) == 0x1111) ?({ _TN_BFA_COMMAND_ERROR_0xAAAA v = 0 +0; if (lmask.i & (lmask.i-1)){ lval.o.T1IF = v; __asm__ __volatile__ ("ior %0":"=U"(IFS0):"a"(lmask.i & lval.i)); } else { if (v & 1) IFS0bits.T1IF = 1; } }), 0 :(((((0xAAAA) == 0x2222) ?({ _TN_BFA_COMMAND_ERROR_0xAAAA v = 0 +0; if (lmask.i & (lmask.i-1)){ lval.o.T1IF = v; __asm__ __volatile__ ("and %0":"=U"(IFS0):"a"(~(lmask.i & lval.i))); } else { if (v & 1) IFS0bits.T1IF = 0; } }), 0 :({ IFS0bits.T1IF; }))))))); });
   ({ union { IEC0BITS o; unsigned int i; } lcur, lmask={}, lval={}; lmask.o.T1IE = -1; ((0xAAAA) == 0xAAAA) ?({ _TN_BFA_COMMAND_ERROR_0xAAAA v = 1 +0; if (lmask.i & (lmask.i-1)){ lval.o.T1IE = v; lcur.o = IEC0bits; __asm__ __volatile__ ("xor %0":"=U"(IEC0):"a"(lmask.i & (lval.i^lcur.i))); } else { if (v & 1) { IEC0bits.T1IE = 1; } else { IEC0bits.T1IE = 0; } } }), 0 :(((0xAAAA) == 0x3333) ?({ _TN_BFA_COMMAND_ERROR_0xAAAA v = 1 +0; lval.o.T1IE = v; __asm__ __volatile__(" xor %0" :"=U"(IEC0):"a"(lmask.i & lval.i)); }), 0 :((((0xAAAA) == 0x1111) ?({ _TN_BFA_COMMAND_ERROR_0xAAAA v = 1 +0; if (lmask.i & (lmask.i-1)){ lval.o.T1IE = v; __asm__ __volatile__ ("ior %0":"=U"(IEC0):"a"(lmask.i & lval.i)); } else { if (v & 1) IEC0bits.T1IE = 1; } }), 0 :(((((0xAAAA) == 0x2222) ?({ _TN_BFA_COMMAND_ERROR_0xAAAA v = 1 +0; if (lmask.i & (lmask.i-1)){ lval.o.T1IE = v; __asm__ __volatile__ ("and %0":"=U"(IEC0):"a"(~(lmask.i & lval.i))); } else { if (v & 1) IEC0bits.T1IE = 0; } }), 0 :({ IEC0bits.T1IE; }))))))); });


   ({ union { T1CONBITS o; unsigned int i; } lcur, lmask={}, lval={}; lmask.o.TON = -1; ((0xAAAA) == 0xAAAA) ?({ _TN_BFA_COMMAND_ERROR_0xAAAA v = 1 +0; if (lmask.i & (lmask.i-1)){ lval.o.TON = v; lcur.o = T1CONbits; __asm__ __volatile__ ("xor %0":"=U"(T1CON):"a"(lmask.i & (lval.i^lcur.i))); } else { if (v & 1) { T1CONbits.TON = 1; } else { T1CONbits.TON = 0; } } }), 0 :(((0xAAAA) == 0x3333) ?({ _TN_BFA_COMMAND_ERROR_0xAAAA v = 1 +0; lval.o.TON = v; __asm__ __volatile__(" xor %0" :"=U"(T1CON):"a"(lmask.i & lval.i)); }), 0 :((((0xAAAA) == 0x1111) ?({ _TN_BFA_COMMAND_ERROR_0xAAAA v = 1 +0; if (lmask.i & (lmask.i-1)){ lval.o.TON = v; __asm__ __volatile__ ("ior %0":"=U"(T1CON):"a"(lmask.i & lval.i)); } else { if (v & 1) T1CONbits.TON = 1; } }), 0 :(((((0xAAAA) == 0x2222) ?({ _TN_BFA_COMMAND_ERROR_0xAAAA v = 1 +0; if (lmask.i & (lmask.i-1)){ lval.o.TON = v; __asm__ __volatile__ ("and %0":"=U"(T1CON):"a"(~(lmask.i & lval.i))); } else { if (v & 1) T1CONbits.TON = 0; } }), 0 :({ T1CONbits.TON; }))))))); });
}
