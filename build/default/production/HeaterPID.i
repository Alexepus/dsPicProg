...
# 49 "Main.h" 2
# 2 "HeaterPID.c" 2
INT16Q8 Kp=((int)(1*256.)), Ki=((int)(1*256.)), Kd=((int)(1*256.)), Kff=((int)(1*256.));
INT16Q4 Vp=((int)(2*16.)), Vi=((int)(3*16.)), Vd=((int)(4*16.)), Vff, Vout;
...
INT16Q16 AdcTcTomVCoef=((int)(0.01*256.*256.));
BYTE DifShift=5;
_Bool TableVLoaded=0,TdTLoaded=0;
BYTE TableDT=0x2A;
INT16Q4 TEnd;
INT32Q20 DeltaT, TAccumulator;
long VoutAcc;
_Bool FlagWait, FlagMainOff, FlagRefTempAchived;
_Bool ManualHeaterControl=0;
...
void task_HeaterPid_body(void *par)
{
 ...
 while (1)
 {
  ...
  if(!FlagMainOff)
  {
   ...
   { MulVarA=ADC8x14DataAveraged[0]; MulVarB=(MulVarA*AdcTcTomVCoef); *((char*)&Temp1)=*(((char*)&MulVarB)+1); *(((char*)&Temp1)+1)=*(((char*)&MulVarB)+2);};
   ...
   { MulVarA=Vi; MulVarB=(MulVarA*IDec); *((char*)&Temp1)=*(((char*)&MulVarB)+1); *(((char*)&Temp1)+1)=*(((char*)&MulVarB)+2);};
   Vi=Vp+Temp1;
   ...
   { MulVarA=Kp; VoutAcc=(MulVarA*Vp)>>8;};
   { MulVarA=Ki; MulVarB=(MulVarA*Vi)>>8;};
   VoutAcc+=MulVarB;
   { MulVarA=Kd; MulVarB=(MulVarA*Vd)>>8;};
   VoutAcc+=MulVarB;
   if(VoutAcc>0x7FFFl)
    VoutAcc=0x7FFFl;
   ...
   { MulVarA=Kff; MulVarB=(MulVarA*Vff)>>8;};
   VoutAcc+=MulVarB;
   if(VoutAcc>0x7FFFl)
    VoutAcc=0x7FFFl;
...
MulVarB=(Voltage-TableV[i])*TableDT;
  { MulVarA=(Voltage-TableV[i])*TableDT; MulVarB=(MulVarA*TableInvDV[i]); *((char*)&Tmp)=*(((char*)&MulVarB)+1); *(((char*)&Tmp)+1)=*(((char*)&MulVarB)+2);};
