...
.LCFI0:
	...
	.loc 1 49 0
	mov	_ADCData,w0
	mov	w0,_ADCDataTemp0
	.loc 1 50 0
	mov	_ADCData+2,w0
	mov	w0,_ADCDataTemp0+2
	.loc 1 51 0
	mov	_ADCData+4,w0
	mov	w0,_ADCDataTemp0+4
	.loc 1 52 0
	mov	_ADCData+6,w0
	mov	w0,_ADCDataTemp0+6
	.loc 1 53 0
	bra	.L1
.L3:
	.loc 1 57 0
	mov	_ADCDataTemp0,w1
	mov	_ADCData,w0
	add	w1,w0,w0
	mov	w0,_ADCDataTemp0
	.loc 1 58 0
	mov	_ADCDataTemp0+2,w1
	mov	_ADCData+2,w0
	add	w1,w0,w0
	mov	w0,_ADCDataTemp0+2
	.loc 1 59 0
	mov	_ADCDataTemp0+4,w1
	mov	_ADCData+4,w0
	add	w1,w0,w0
	mov	w0,_ADCDataTemp0+4
	.loc 1 60 0
	mov	_ADCDataTemp0+6,w1
	mov	_ADCData+6,w0
	add	w1,w0,w0
	mov	w0,_ADCDataTemp0+6
	bra	.L5
.L2:
	...
	.loc 1 67 0
	mov	_ADCData,w0
	mov	w0,_ADCDataTemp1
	.loc 1 68 0
	mov	_ADCData+2,w0
	mov	w0,_ADCDataTemp1+2
	.loc 1 69 0
	mov	_ADCData+4,w0
	mov	w0,_ADCDataTemp1+4
	.loc 1 70 0
	mov	_ADCData+6,w0
	mov	w0,_ADCDataTemp1+6
	.loc 1 71 0
	bra	.L1
.L6:
	.loc 1 75 0
	mov	_ADCDataTemp1,w1
	mov	_ADCData,w0
	add	w1,w0,w0
	mov	w0,_ADCDataTemp1
	.loc 1 76 0
	mov	_ADCDataTemp1+2,w1
	mov	_ADCData+2,w0
	add	w1,w0,w0
	mov	w0,_ADCDataTemp1+2
	.loc 1 77 0
	mov	_ADCDataTemp1+4,w1
	mov	_ADCData+4,w0
	add	w1,w0,w0
	mov	w0,_ADCDataTemp1+4
	.loc 1 78 0
	mov	_ADCDataTemp1+6,w1
	mov	_ADCData+6,w0
	add	w1,w0,w0
	mov	w0,_ADCDataTemp1+6
.L5:
	.loc 1 81 0
	mov	_ADCDataTemp0,w1
	mov	_ADCDataTemp1,w0
	add	w1,w0,w0
	lsr	w0,#2,w0
	mov	w0,_ADCDataAveraged
	.loc 1 82 0
	mov	_ADCDataTemp0+2,w1
	mov	_ADCDataTemp1+2,w0
	add	w1,w0,w0
	lsr	w0,#2,w0
	mov	w0,_ADCDataAveraged+2
	.loc 1 83 0
	mov	_ADCDataTemp0+4,w1
	mov	_ADCDataTemp1+4,w0
	add	w1,w0,w0
	lsr	w0,#2,w0
	mov	w0,_ADCDataAveraged+4
	.loc 1 84 0
	mov	_ADCDataTemp0+6,w1
	mov	_ADCDataTemp1+6,w0
	add	w1,w0,w0
	lsr	w0,#2,w0
