...
void Limiter(void)
{
 ...
 if(ADC8x14DataAveraged[1] != 0)
  KHeaterIToRef = Tmp.AsUlong/(ULONG)ADC8x14DataAveraged[1];
 else
  KHeaterIToRef = 0xffffffff;

 Tmp.AsUlong = KHeaterIToRef_Medium*244 + KHeaterIToRef*12;

 KHeaterIToRef_Medium = Tmp.AsStruct.MInt;
 { MulVarA=MaxHeaterISoft; MulVarB=(MulVarA*KHeaterIToRef_Medium); *((char*)&DacData0Max)=*(((char*)&MulVarB)+1); *(((char*)&DacData0Max)+1)=*(((char*)&MulVarB)+2);};
 ...
 { MulVarA=ADC8x14DataAveraged[1]; MulVarB=(MulVarA*ADC8x14DataAveraged[2]); *((char*)&HeaterP)=*(((char*)&MulVarB)+2); *(((char*)&HeaterP)+1)=*(((char*)&MulVarB)+3);};
