...
void Limiter(void)
{
 ...
 if(ADCDataAveraged[1] != 0)
  KHeaterIToRef = Tmp.AsUlong/(ULONG)ADCDataAveraged[1];
 else
 ...
 { MulVarA=ADCDataAveraged[1]; MulVarB=(MulVarA*ADCDataAveraged[2]); *((char*)&HeaterP)=*(((char*)&MulVarB)+2); *(((char*)&HeaterP)+1)=*(((char*)&MulVarB)+3);};
